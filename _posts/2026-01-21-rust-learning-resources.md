...
![Illustration of learning Rust concepts](/images/learn-rust.jpg)

## Official core resources

**1. The Rust Programming Language (The Book)**

- Official, comprehensive intro to Rust maintained by the Rust team. [rust-lang](https://rust-lang.org/learn/)
- Best as a primary reference plus exercises from other sources.

**2. Rust official "Learn" page**

- Central hub listing The Book, standard library docs, Rust by Example, Cargo book, compiler error index, and more. [rust-lang](https://rust-lang.org/learn/)
- Good starting page to bookmark when you need docs and guides in one place.

**3. Rust by Example (via Learn page)**

- Example-driven mini chapters that complement The Book with runnable snippets. [rust-lang](https://rust-lang.org/learn/)
...
- Free course from the Android team at Google; covers fundamentals up to generics, error handling, and some Android-specific content. [google.github](https://google.github.io/comprehensive-rust/)
...
- Full beginner-friendly Rust course on YouTube, ~14 hours, created by Arfan Zubi. [freecodecamp](https://www.freecodecamp.org/news/rust-programming-course-for-beginners/)
...
- ~4-hour video focusing on ownership, borrowing, memory management, structs, enums, pattern matching, error handling, and more. [youtube](https://www.youtube.com/watch?v=qP7LzZqGh30)
...
- University-level Rust course with modules, labs, and one assignment; you can "audit" and view content for free. [coursera](https://www.coursera.org/learn/rust-fundamentals)
...
- Popular repo of small exercises; you fix failing code/tests to learn reading and writing Rust. [github](https://github.com/ImplFerris/LearnRust)
...
- Browser-based platform with integrated Rust compiler and step-by-step lessons plus many practice problems. [rustfinity](https://www.rustfinity.com)
- Good if you want LeetCode-style practice tailored specifically to Rust.

**10. 100 Exercises to Learn Rust**

- Self-paced exercise set that takes you through Rust concepts one small problem at a time, listed in the LearnRust curated repo. [github](https://github.com/ImplFerris/LearnRust)
...
- Curated list of free Rust books, exercises, videos, cheat sheets, project ideas, and more, tagged by level. [github](https://github.com/ImplFerris/LearnRust)
